...
private let localizationStrings: [AppLanguage: [String: String]] = [
    .english: [
        ...
        "Reset": "Reset",
        "Reset System Cursor": "Reset System Cursor",
        "Reset Sidebar Order": "Reset Sidebar Order",
        "System cursor has been reset to default.": "System cursor has been reset to default.",
        "Sidebar order has been reset to alphabetical.": "Sidebar order has been reset to alphabetical.",
    ...
    .chinese: [
        ...
        "Reset": "重置",
        "Reset System Cursor": "恢复系统默认光标",
        "Reset Sidebar Order": "重置导航栏排序",
        "System cursor has been reset to default.": "系统光标已恢复为默认。",
        "Sidebar order has been reset to alphabetical.": "导航栏排序已重置为字母顺序。",
